...
void bubble_sort(SinglyLinkedList* list, int (*cmp)(void*, void*)) {
    if (is_empty(list)) return;  // Return if the list is empty
    ...
    do {
        ...
        while (current != NULL && current->next != NULL) {
            ...
            // Compare current node and next node data
...
int main() {
    ...
    traverse(list, print_int);  // Output: 10 20 30
    printf("\n");
